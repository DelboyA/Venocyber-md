...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "💥🦞🎯🎯🎯DJ DELBOY ANIEY MIXTAPES",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "💥🦞🎯🎯🎯DJ DELBOY ANIEY MIXTAPES",
  ...
  LANG: (process.env.THEME || "💥🦞🎯🎯🎯DJ DELBOY ANIEY MIXTAPES").toUpperCase(),
};
global.rank = "updated";
